...
public class ChkPlan {
	...
	public ChkPlan(ChkPlanPK id) {
		setId(id);
	}

	public ChkPlan(Integer branchId, String no) {
		this(new ChkPlanPK(branchId, no));
	}
	...
	public ChkPlanPK getId() {
		return id;
	}

	public void setId(ChkPlanPK id) {
		this.id = id;
	}
	...
	public boolean equals(Object obj) {
		ChkPlan po = (obj instanceof ChkPlan) ? (ChkPlan) obj : null;
	...
	public String toString() {
		...
		sb.append("HrChkPlan{id=").append(id)
	...
	public static ChkPlan getSafeObject(ChkPlan po) {
		if (Hibernate.isInitialized(po)) {
			if (po instanceof HibernateProxy) return (ChkPlan) ((HibernateProxy) po).getHibernateLazyInitializer().getImplementation();
			else return po;
		} else {
			if (po == null) return null;
			else return new ChkPlan(po.getId());
		}
	}
